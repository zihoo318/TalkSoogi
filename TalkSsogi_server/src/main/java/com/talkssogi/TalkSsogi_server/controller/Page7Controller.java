...
public class Page7Controller {
    ...
    public Map<String, Map<String, Integer>> getBasicRankingResults(@RequestParam("crnum") Integer crnum) {
    ...
    public Map<String, Map<String, Integer>> getSearchRankingResults(@RequestParam("crnum") Integer crnum, @RequestParam("keyword") String keyword) {
        // 기본 제공 랭킹 결과를 생성
